(function () {
  ...
  var css = `
    ...
    .highlight-chat .hl-message .hl-badges img { height: 16px !important; max-height: 16px !important; width: auto !important; vertical-align: middle !important; margin-right: 2px !important; }
    .highlight-chat .hl-message .hl-name { font-family: 'Open Sans', sans-serif !important; font-size: 13px !important; font-weight: 700 !important; background: transparent !important; padding: 0 !important; margin-right: 4px !important; text-shadow: 1px 1px 2px rgba(0,0,0,.9), -1px -1px 2px rgba(0,0,0,.9) !important; }
    .highlight-chat .hl-message .hl-content { color: #fff !important; -webkit-text-fill-color: #fff !important; font-family: 'Open Sans', sans-serif !important; font-size: 13px !important; font-weight: 700 !important; text-shadow: 1px 1px 2px rgba(0,0,0,.9), -1px -1px 2px rgba(0,0,0,.9) !important; }
